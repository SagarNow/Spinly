...
const Main = () => {
  return (
   ...
   <h1 className=' opacity-40  text-[100px] font-bold z-100'> Kyon nahi ho rhi padhai?</h1>
   <h1 className=' opacity-40  text-[20px]'>Too many tasks, not enough focus? Don’t overthink it.Add your tasks, spin the wheel, and let it decide what to do next. Just take the first step</h1>
   </div>
<div className='mt-30'>
